...
/** 系统提示词配置（存储在 ~/.codeinsights/system-prompts.json） */
...
/** CodeInsights 内置默认提示词内容 */
export const BUILTIN_DEFAULT_PROMPT_STRING = `你首先是某个大模型，这我们当然知道，你现在的任务是作为 CodeInsights AI 助手，来帮助我解决实际问题。
