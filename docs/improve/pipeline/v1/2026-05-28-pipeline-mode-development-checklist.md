...
> 最新已确认恢复入口：`e77139fd docs(pipeline): 校正 Phase 8 最新恢复入口`；Phase 8 开发基线为 `fb864d6a`，上一恢复入口为 `7d309cc0`。
...
4. 每次开始前仍需读取 `tasks/lessons.md`、本文和 `next-session-prompt.md`，并确认历史包含 `e77139fd docs(pipeline): 校正 Phase 8 最新恢复入口`、`7d309cc0 docs(pipeline): 回填 Phase 8 最新恢复状态`、`c79f6b48 docs(pipeline): 同步 Phase 8 后续开发状态`、`fb864d6a feat(pipeline): 完成 Pipeline v1 Phase 8 报告 HTML 与 PDF 导出` 和 `b4ed7b1e docs(pipeline): 回填 Phase 7 最新恢复状态`。
