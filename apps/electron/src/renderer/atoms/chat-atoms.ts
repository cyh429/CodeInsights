...
import type { ConversationMeta, ChatMessage, FileAttachment, ChatToolActivity, Channel } from '@codeinsights/shared'
...
export const thinkingExpandedAtom = atomWithStorage<boolean>(
  'codeinsights-thinking-expanded',
  false,
)