 ...
 * - themeModeAtom: 用户选择的主题模式，持久化到 ~/.codeinsights/settings.json
...
/** localStorage 缓存键 */
const THEME_CACHE_KEY = 'codeinsights-theme-mode'
const THEME_STYLE_CACHE_KEY = 'codeinsights-theme-style'
