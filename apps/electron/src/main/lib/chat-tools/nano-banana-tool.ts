 ...
 * 支持文生图、参考图编辑、多轮连续修改。
 * 凭据存储在 ~/.codeinsights/chat-tools.json 的 toolCredentials 中。
 */

import type { ToolCall, ToolResult, ToolDefinition } from '@codeinsights/core'
import type { ChatToolMeta, FileAttachment } from '@codeinsights/shared'
